...
class MoonshineGenerator < Rails::Generators::Base
  ...
  class_option :ruby, :default => default_ruby, :desc => 'Ruby version to install. Currently supports: mri, ree, ree187, src187, src192, src193, src193falcon, src200', :type => :string
